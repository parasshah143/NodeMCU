...
#define WLAN_SSID       "pic_track143"
#define WLAN_PASS       "pic_track143"
const int PIR1 = D1;
const int PIR2 = D2;
const int REED = D3;
const int LIGHT = D4;
...
#define AIO_USERNAME    "Paras123"
#define AIO_KEY         "bc6e522fe7624e5d8effc8cfd5bcde43"
...
const char PHOTOCELL_FEED[] PROGMEM = AIO_USERNAME "/feeds/touch";
Adafruit_MQTT_Publish photocell = Adafruit_MQTT_Publish(&mqtt, PHOTOCELL_FEED);

// Setup a feed called 'topic1' for publishing.
// Notice MQTT paths for AIO follow the form: <username>/feeds/<feedname>
const char PHOTOCELL_FEED1[] PROGMEM = AIO_USERNAME "/feeds/ldr";
